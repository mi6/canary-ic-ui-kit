...
- Caption: `string`
- Columns: `IcUnstableDataTableColumnObject[]`
...
<Canvas withSource="none">
  <Story name="Basic">
    <IcUnstableDataTable caption="Basic" columns={COLS} data={DATA} />
  </Story>
</Canvas>
...
import { IcUnstableDataTable } from "@ukic/react";
import { IcUnstableDataTableColumnObject } from "@ukic/web-components";

const columns: IcUnstableDataTableColumnObject[] = [
  {
    key: "firstName",
    title: "First name",
    dataType: "string",
...
const DataTable = () => (
  <IcUnstableDataTable caption="Basic" columns={columns} data={data} />
);
...
const DataTable = () => (
  <IcUnstableDataTable caption="Embedded" columns={columns} data={data} embedded />
);
...
<Canvas withSource="none">
  <Story name="Sort">
    <IcUnstableDataTable caption="Sort" columns={COLS} data={DATA} sortable />
  </Story>
</Canvas>
