...
describe("ic-date-input component", () => {
  it("should render", async () => {
    const page = await newSpecPage({
      ...
      html: `<ic-unstable-date-input label="Test label"></ic-unstable-date-input>`,
    });
  ...
  it("should render as required", async () => {
    const page = await newSpecPage({
      components: [DateInput, InputLabel],
      html: `<ic-unstable-date-input label="Test label" required></ic-unstable-date-input>`,
    });
  ...
  it("should render as disabled", async () => {
    const page = await newSpecPage({
      components: [DateInput, InputLabel],
      html: `<ic-unstable-date-input label="Test label" disabled></ic-unstable-date-input>`,
    });
  ...
  it("should render with custom helper text", async () => {
    const page = await newSpecPage({
      components: [DateInput, InputLabel],
      html: `<ic-unstable-date-input label="Test label" helper-text="Test helper text"></ic-unstable-date-input>`,
    });
  ...
  it("should render correctly with MM/DD/YYYY format", async () => {
    const page = await newSpecPage({
      components: [DateInput, InputLabel],
      html: `<ic-unstable-date-input label="Test label" date-format="MM/DD/YYYY"></ic-unstable-date-input>`,
    });
  ...
  it("should render correctly with YYYY/MM/DD format", async () => {
    const page = await newSpecPage({
      components: [DateInput, InputLabel],
      html: `<ic-unstable-date-input label="Test label" date-format="YYY/MM/DD"></ic-unstable-date-input>`,
    });
  ...
  it("should render with custom validation status and text", async () => {
    const page = await newSpecPage({
      components: [DateInput, InputLabel],
      html: `<ic-unstable-date-input label="Test label" validation-status="error" validation-text="Test error text"></ic-unstable-date-input>`,
    });
