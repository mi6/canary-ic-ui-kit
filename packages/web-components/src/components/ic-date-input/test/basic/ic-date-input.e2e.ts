...
describe("ic-date-input", () => {
  it("should update value on ArrowUp on day input", async () => {
    ...
    await page.setContent(`<ic-unstable-date-input label="Test label"></ic-unstable-date-input>`);
  ...
  it("should set date using forward slashes to switch inputs", async () => {
    ...
    await page.setContent(
      `<ic-unstable-date-input label="Test label"></ic-unstable-date-input>
